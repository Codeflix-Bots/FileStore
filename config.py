...
APP_ID = int(os.environ.get("APP_ID", "28638866")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "a748074bea1e6ace57394aceb194d292") #Your API Hash from my.telegram.org
#--------------------------------------------
