...
APP_ID = int(os.environ.get("APP_ID", "29841034")) #Your api id ID from my.telegram.org
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "e6ef7ec363d0509cd7e1d9a033217a71a6ffd664")
