...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7560670739:")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "25030079"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "21e2ac3c486d1244349bb436e36c738d")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002368519043"))
# NAMA OWNER
OWNER = os.environ.get("OWNER", "7989884074")
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7989884074"))
#Port
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002417253194"))
#put 0 to disable
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001977748968"))
#put 0 to disable
...
try:
    ADMINS=[7989884074]
    for x in (os.environ.get("ADMINS", "7989884074 7556194515").split()):
        ADMINS.append(int(x))
except ValueError:
