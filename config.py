...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7591126816:AAG33WL3m3vWvVk43yGKgN-P41sobaYqbuk")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002386383823")) #Your db channel Id
OWNER = os.environ.get("OWNER", "sewxiy") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "7768598381")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://musicbhaikon9910:krishna@cluster0.cwvegmt.mongodb.net/")
DB_NAME = os.environ.get("DATABASE_NAME", "ADRDB")
#--------------------------------------------
