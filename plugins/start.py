...
async def start_command(client: Client, message: Message):
        ...
        if not is_user_pro and user_id != OWNER_ID and not is_short_link and shortner_enabled:
            ...
            await client.send_photo(
                ...
                reply_markup=InlineKeyboardMarkup([
                    ...
                    [
                        InlineKeyboardButton(" • ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ •", url="https://t.me/spicypremium")
                    ]
                ])
            )
    ...
    # 9. Normal start message
        ...
        buttons = [
                # Add your 2 new buttons here
                InlineKeyboardButton("ᴏηʟʏғᴀɴѕ", url="https://t.me/+ZDkji3X74JM1MWE1"), 
                InlineKeyboardButton("Leaks", url="https://t.me/+WZ4lSA19L0piZWM1")
            ]
        ],
...
async def request_command(client: Client, message: Message):
    ...
    if not is_user_premium: 
        BUTTON_URL = "https://t.me/Spicylinebun/5"
        reply_markup = InlineKeyboardMarkup([
